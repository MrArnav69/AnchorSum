#!/usr/bin/env python3
"""
Simplified AlignScore Evaluation Script
Clean format: id, alignscore
Calculates factual consistency between summaries and source documents
"""
...
def main():
    ...
    print("=" * 60)
    print("📋 Format: id, alignscore, method")
    print("📋 Model: AlignScore-large (factual consistency)")
    print()
    ...
    if HAS_ALIGNSCORE:
        ...
        print("⚠️ AlignScore not available - install from AlignScore/ directory")
    print()
    ...
    print("🎉 AlignScore evaluation completed!")
