#!/usr/bin/env python3
"""
BARTScore Evaluation for full_revisions_2 results
...
def main():
    ...
    output_dir = 'bartscore_full_revisions_2_results'
    
    print("🔬 BARTScore EVALUATION - Full Revisions 2")
    print("=" * 60)
    ...
    try:
        ...
        print("=" * 60)
        print(f"\n🎯 Performance Metrics:")
        print(f"   BARTScore sum2doc: {stats['bartscore_sum2doc_mean']:.4f} (±{stats['bartscore_sum2doc_std']:.4f})")
        print(f"   BARTScore doc2sum: {stats['bartscore_doc2sum_mean']:.4f} (±{stats['bartscore_doc2sum_std']:.4f})")
        
        print(f"\n📁 Results saved to:")
        print(f"   - {output_dir}/bartscore_detailed_full_revisions_2.csv")
        print(f"   - {output_dir}/bartscore_summary_full_revisions_2.csv")
