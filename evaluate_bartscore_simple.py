#!/usr/bin/env python3
"""
Simple BARTScore Evaluation for Ablation Files
Based on your script structure but for our ablation data
"""
...
class SimpleBARTScoreEvaluator:
    ...
    def calculate_scores(self, data: List[Dict], original_documents) -> pd.DataFrame:
        ...
        try:
            # Calculate both scores with smaller batches to avoid memory issues
            sum2doc_scores = []
            doc2sum_scores = []
...
def main():
    ...
    print("🔬 SIMPLE BARTScore EVALUATION")
    print("=" * 60)
    ...
    for file_path in ablation_files:
        print(f"   • {file_path}")
    print()
    print("⚡ Optimized: Small batches, error handling")
    print()
    ...
    output_dir = 'bartscore_simple_results'
    os.makedirs(output_dir, exist_ok=True)
    ...
    print("🎉 Simple BARTScore evaluation completed!")
