...
class SummaCOnlyEvaluator:
    def __init__(self, device='cuda:0', batch_size=16):
        ...
        logger.info("Initializing SummaC...")
    ...
    def calculate_scores(self, data: List[Dict], original_documents) -> pd.DataFrame:
        ...
        try:
            # Calculate SummaC scores in batches
            scores = []
            ...
            logger.error(f"Error calculating SummaC: {e}")
...
def main():
    ...
    for file_path in ablation_files:
        print(f"   • {file_path}")
    print()
    print("⚡ Optimized: Vitc model, proper ID matching")
    print()
    
    # Initialize evaluator
    evaluator = SummaCOnlyEvaluator(device='cuda:0', batch_size=16)
    
    # Create output directory
    output_dir = 'summac_results'
    os.makedirs(output_dir, exist_ok=True)
    ...
    print("🎉 SummaC evaluation completed!")
